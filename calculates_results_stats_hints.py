...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Pet Image Label is NOT a Dog
            ...
            if results_dic[key][4] == 0:
                results_stat['n_correct_notdogs'] += 1
    ...
    results_stats_dic['pct_match'] = (results_stats['n_match']/results_stats['n_images'])*100
    ...
    results_stats_dic['pct_correct_dogs'] = (results_stats['n_correct_dogs']/results_stats['n_dogs_img'])*100
    ...
    results_stats_dic['pct_correct_breed'] = (results_stats['n_correct_breed']/results_stats['n_dogs_img'])*100
